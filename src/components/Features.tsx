                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    ...
                                    <p className="text-foreground">Built with enterprise-grade security features, 2FA authentication, and data protection.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    ...
                                    <p className="text-foreground">Optimized performance with React 19, Vite, and modern build tools for instant loading.</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">Authentication Ready</h2>
                                        <p className="text-foreground">Complete auth system with magic links, OAuth providers, and team management built-in.</p>
                                    </div>
                                </div>
                                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
                                    ...
                                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                        <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Circuit</span>
                                        <div className="ring-background size-7 ring-4">
                                            <Image className="size-full rounded-full" src="https://images.unsplash.com/photo-1518770660439-4636190af475?w=150&h=150&fit=crop" alt="Circuit board" width={150} height={150} />
                                        </div>
                                    </div>
                                    <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                        <div className="ring-background size-8 ring-4">
                                            <Image className="size-full rounded-full" src="https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=150&h=150&fit=crop" alt="Robot" width={150} height={150} />
                                        </div>
                                        <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Robot</span>
                                    </div>
                                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                        <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Drone</span>
                                        <div className="ring-background size-7 ring-4">
                                            <Image className="size-full rounded-full" src="https://images.unsplash.com/photo-1487887235947-a955ef187fcc?w=150&h=150&fit=crop" alt="Drone" width={150} height={150} />
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
                            ...
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-foreground">Multi-tenant organizations with role-based access control and invitation system.</p>
                                    </div>
                                </div>
